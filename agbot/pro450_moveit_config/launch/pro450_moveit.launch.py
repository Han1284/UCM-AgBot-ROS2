...
def generate_launch_description():
    ...
    ompl = {'ompl': {'planning_plugin': 'ompl_interface/OMPLPlanner', 'request_adapters': 'default_planner_request_adapters/FixWorkspaceBounds default_planner_request_adapters/FixStartStateBounds default_planner_request_adapters/FixStartStateCollision', 'start_state_max_bounds_error': 0.1}}
    ...
    parameters = [robot_description, semantic, planning, kinematics, ompl, pipelines, controllers, {'use_sim_time': use_sim_time, 'publish_robot_description_semantic': True, 'allow_trajectory_execution': False}]
